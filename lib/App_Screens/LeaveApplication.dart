...
import 'package:lm_student/Resources/UserLeaveMethods.dart';
import 'package:lm_student/Reusable_Utils/AppBar.dart';
import 'package:lm_student/Reusable_Utils/Heightwidth.dart';
...
import '../Reusable_Utils/ExpandedTextForm.dart';
import '../Reusable_Utils/TextFormField.dart';
...
class _LeaveApplicationState extends State<LeaveApplication> {
  ...
  void applyLeave() async {
    ...
    String finalResult = await UserLeaveMethods().applyLeave(
        fullName: name,
        dept: dept,
        semester: semester,
        email: email,
    ...
    if(finalResult == "success"){
      ...
      snackBar(content: "Leave Applied Successfully", duration: 2000, context: context);
    }
    else{
          ...
          child: Column(
            ...
            children: [
             ...
             Row(mainAxisAlignment: MainAxisAlignment.center, children: [
               ...
               Text(((userModel.leaveTaken)).toString(),
                 style: textStyle,
               ),
             ],),
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: (
                          selectedDate1.compareTo(date)>0)?Text(formattedDate.format(selectedDate1).toString(),
                        style: TextStyle(
              ...
              SizedBox(height: resize.screenLayout(180, context),),
              Container(
