...
class _ClassAnnouncementState extends State<ClassAnnouncement> {
                    ...
                    Row(
                      ...
                      children: [
                        CircleAvatar(
                            ...
                            backgroundImage: (announcerImage == 'null')?
                            null:
  ...
  Widget build(BuildContext context) {
    ...
    print(semester);
    final Stream<QuerySnapshot> announcements = FirebaseFirestore.instance.collection('announcement').where('isForStudent', isEqualTo: 'true').where('semester', isEqualTo: semester).orderBy("announcedate").snapshots();
    return Scaffold(
          ...
          return ListView.builder(
              ...
              itemBuilder: (_, int index){
                ...
                return ListTile(
                  ...
                  title: Text(subject),
                  leading: (imageUrl == 'null') ? Initicon(
